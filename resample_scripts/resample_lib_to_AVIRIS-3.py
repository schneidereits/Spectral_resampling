...
AVIRIS_BAND_SPEC_PATH = "wavelength/AVIRIS-3_spectral_config.csv"
OUT_DIR = "."

# Output files
RESAMPLED_RAW_PATH = os.path.join(OUT_DIR, "spectral_library_resampled_AVIRIS-3.csv")
RESAMPLED_INTERP_PATH = os.path.join(OUT_DIR, "spectral_library_resampled_AVIRIS-3_interpolated.csv")
