...
AVIRIS_BAND_SPEC_PATH = "wavelength/AVIRIS-NG_spectral_config.csv"
OUT_DIR = "."

# Output files
RESAMPLED_RAW_PATH = os.path.join(OUT_DIR, "spectral_library_resampled_AVIRIS-NG.csv")
RESAMPLED_INTERP_PATH = os.path.join(OUT_DIR, "spectral_library_resampled_AVIRIS-NG_interpolated.csv")
...
def main():
    ...
    # --- Load AVIRIS-3 band configuration ---
    aviris = pd.read_csv(AVIRIS_BAND_SPEC_PATH, header=None)
    band_centers = aviris.iloc[:, 0].values
    band_fwhm = aviris.iloc[:, 1].values
